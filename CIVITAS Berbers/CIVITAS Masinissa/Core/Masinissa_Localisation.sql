...
-----------------------------------------------	
	...
	("en_US",	"LOC_LEADER_CVS_MASINISSA_NAME",  "Masinissa"	),
	
-----------------------------------------------
-- UA
-----------------------------------------------	

	("en_US",	"LOC_TRAIT_LEADER_CVS_MASINISSA_UA_NAME",  "Inumiden"	),
	("en_US",	"LOC_TRAIT_LEADER_CVS_MASINISSA_UA_DESCRIPTION",
	"Tiles adjacent to City Centers produce +1 [ICON_FOOD] Food. If you have at least one alliance, every time you capture a foreign city, your workers gain an additional charge. Gains access to the Numidian Cavalry unit."	),

-----------------------------------------------
-- UU
-----------------------------------------------

	("en_US",	"LOC_UNIT_CVS_MASINISSA_UU_NAME",	"Numidian Cavalry"	),
	("en_US",	"LOC_UNIT_CVS_MASINISSA_UU_DESCRIPTION",	 
	"A ranged cavalry unit unique to Berbers. Replaces the Horseman. Extra movement if beginning its turn on a desert tile. Uses less movement to pillage tiles. Can move after attacking."	),

-----------------------------------------------
-- Agenda
-----------------------------------------------	

	("en_US",	"LOC_AGENDA_CVS_MASINISSA_NAME",	"The Best Man of All Kings"	),
	("en_US",	"LOC_AGENDA_CVS_MASINISSA_DESCRIPTION",	"Likes civilizations on foreign continents with larger populations. Dislikes those on his home continent that have a higher income."	),
	
	("en_US",	"LOC_DIPLO_KUDO_LEADER_CVS_MASINISSA_REASON_ANY",	"(You have large cities on a foreign continent.)"	),
	("en_US",	"LOC_DIPLO_MODIFIER_CVS_MASINISSA_HAPPY",	"Masinissa is impressed by your populous cities"	),
	
	("en_US",	"LOC_DIPLO_WARNING_LEADER_CVS_MASINISSA_REASON_ANY",	"(You have a higher income and are on his continent.)"	),
	("en_US",	"LOC_DIPLO_MODIFIER_CVS_MASINISSA_UNHAPPY",	"Masinissa is displeased that a neighboring civilization has more riches than him"	),

-----------------------------------------------
-- DOM
-----------------------------------------------	

	("en_US",	"LOC_LOADING_INFO_LEADER_CVS_MASINISSA",
...
-----------------------------------------------	
	...
	-- First AI Line (ANY)
	("en_US",	"LOC_DIPLO_FIRST_MEET_LEADER_CVS_MASINISSA_ANY",
	...
	("en_US",	"LOC_DIPLO_FIRST_MEET_VISIT_RECIPIENT_LEADER_CVS_MASINISSA_ANY",
	...
	("en_US",	"LOC_DIPLO_FIRST_MEET_NEAR_INITIATOR_POSITIVE_LEADER_CVS_MASINISSA_ANY",
	"I am glad to hear it."	),
	
	-- AI invitation to exchange Capital Information (ANY)
	("en_US",	"LOC_DIPLO_FIRST_MEET_NO_MANS_INFO_EXCHANGE_LEADER_CVS_MASINISSA_ANY",
...
-----------------------------------------------	
	...
	-- (HAPPY)
	("en_US",	"LOC_DIPLO_GREETING_LEADER_CVS_MASINISSA_HAPPY",
	"It has been too long. Have you business with me?"	),

	-- (UNHAPPY)
	("en_US",	"LOC_DIPLO_GREETING_LEADER_CVS_MASINISSA_UNHAPPY",
	"Speak."	),
...
-----------------------------------------------	
	...
	-- AI Accepts (ANY)
	("en_US",	"LOC_DIPLO_ACCEPT_DELEGATION_FROM_HUMAN_LEADER_CVS_MASINISSA_ANY",
	...
	-- AI Rejects (ANY)
	("en_US",	"LOC_DIPLO_REJECT_DELEGATION_FROM_HUMAN_LEADER_CVS_MASINISSA_ANY",
	"That would be ill-advised at this time. For the good of Wallachia, I cannot accept."	),
	
	-- AI Requests (ANY)
	("en_US",	"LOC_DIPLO_DELEGATION_FROM_AI_LEADER_CVS_MASINISSA_ANY",
...
-----------------------------------------------	
	...
	("en_US",	"LOC_DIPLO_ACCEPT_OPEN_BORDERS_FROM_HUMAN_LEADER_CVS_MASINISSA_ANY",
	"You pose no threat to my people or rule, so I shall grant this request."	),
	
	-- AI rejects from human (ANY)	
	("en_US",	"LOC_DIPLO_REJECT_OPEN_BORDERS_FROM_HUMAN_LEADER_CVS_MASINISSA_ANY",
	"Wallachia shall not bid welcome to outsiders."	),
	
	-- AI requests from human (ANY)	
	("en_US",	"LOC_DIPLO_OPEN_BORDERS_FROM_AI_LEADER_CVS_MASINISSA_ANY",
...
-----------------------------------------------	
	...
	-- AI accepts from human (ANY)
	("en_US",	"LOC_DIPLO_ACCEPT_DECLARE_FRIEND_FROM_HUMAN_LEADER_CVS_MASINISSA_ANY",
	"Indeed, you are a proven and trustworthy friend to my kingdom. I stand by you, pikes at the ready."	),
	
	-- AI rejects from human (ANY)	
	("en_US",	"LOC_DIPLO_REJECT_DECLARE_FRIEND_FROM_HUMAN_LEADER_CVS_MASINISSA_ANY",
	"Do not presume I am so easily won over."	),
	
	-- AI Requests friendship from human (ANY)	
	("en_US",	"LOC_DIPLO_DECLARE_FRIEND_FROM_AI_LEADER_CVS_MASINISSA_ANY",
	...
	("en_US",	"LOC_DIPLO_ACCEPT_DECLARE_FRIEND_FROM_AI_LEADER_CVS_MASINISSA_ANY",
	"Thank you for agreeing. May this friendship last through the era and beyond."	),
	
	-- Human rejects AI requests, AI responds (ANY)	
	("en_US",	"LOC_DIPLO_REJECT_DECLARE_FRIEND_FROM_AI_LEADER_CVS_MASINISSA_ANY",
	"Disappointing."	),
...
-----------------------------------------------	
	...
	("en_US",	"LOC_DIPLO_MAKE_ALLIANCE_FROM_AI_LEADER_CVS_MASINISSA_ANY",
...
-----------------------------------------------	
	...
	("en_US",	"LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_LEADER_CVS_MASINISSA_HAPPY",
	...
	("en_US",	"LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_LEADER_CVS_MASINISSA_UNHAPPY",
	...
	("en_US",	"LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_AI_RESPONSE_POSITIVE_LEADER_CVS_MASINISSA_HAPPY",
	...
	("en_US",	"LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_AI_RESPONSE_POSITIVE_LEADER_CVS_MASINISSA_UNHAPPY",
	...
	("en_US",	"LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_AI_RESPONSE_NEGATIVE_LEADER_CVS_MASINISSA_ANY",
...
-----------------------------------------------	
	...
	("en_US",	"LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_LEADER_CVS_MASINISSA_HAPPY",
	"You have settled too close to my people's lands. Refrain from doing this again.."	),
	
	-- AI warns player for settling too close (UNHAPPY)
	("en_US",	"LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_LEADER_CVS_MASINISSA_UNHAPPY",
	"The lands you just claimed belong to Wallachia. Insolence will not be tolerated."	),
	
	-- Positive AI response to human request (HAPPY)
	("en_US",	"LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_POSITIVE_LEADER_CVS_MASINISSA_HAPPY",
	...
	("en_US",	"LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_POSITIVE_LEADER_CVS_MASINISSA_UNHAPPY",
	...
	("en_US",	"LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_NEGATIVE_LEADER_CVS_MASINISSA_HAPPY",
	"There is no need to be hasty, we are able to peacefully coexist in close proximity."	),
	
	-- Negative AI response to human request (UNHAPPY)
	("en_US",	"LOC_DIPLO_WARNING_DONT_SETTLE_NEAR_ME_AI_RESPONSE_NEGATIVE_LEADER_CVS_MASINISSA_UNHAPPY",
...
-----------------------------------------------	
	...
	("en_US",	"LOC_DIPLO_ACCEPT_MAKE_DEAL_FROM_AI_LEADER_CVS_MASINISSA_HAPPY",
	"Very well."	),
	
	-- AI Accepts Deal (Unhappy)
	("en_US",	"LOC_DIPLO_ACCEPT_MAKE_DEAL_FROM_AI_LEADER_CVS_MASINISSA_UNHAPPY",
	"This will have to suffice."	),

	-- AI Rejects Deal (HAPPY)
	("en_US",	"LOC_DIPLO_REJECT_MAKE_DEAL_FROM_AI_LEADER_CVS_MASINISSA_HAPPY",
	"You can do better than this."	),
	
	-- AI Rejects Deal (Unhappy)
	("en_US",	"LOC_DIPLO_REJECT_MAKE_DEAL_FROM_AI_LEADER_CVS_MASINISSA_UNHAPPY",
...
-----------------------------------------------	
	...
	("en_US",	"LOC_DIPLO_DENOUNCE_FROM_HUMAN_LEADER_CVS_MASINISSA_ANY",
	...
	-- From AI
	("en_US",	"LOC_DIPLO_DENOUNCE_FROM_AI_LEADER_CVS_MASINISSA_ANY",
...
-----------------------------------------------	
	...
	("en_US",	"LOC_DIPLO_DECLARE_WAR_FROM_HUMAN_LEADER_CVS_MASINISSA_ANY",
	"May your gods offer you salvation, for you shall find none by my hand."	),
	
	-- AI Declares War
	("en_US",	"LOC_DIPLO_DECLARE_WAR_FROM_AI_LEADER_CVS_MASINISSA_ANY",
...
-----------------------------------------------	
	...
	("en_US",	"LOC_DIPLO_MAKE_PEACE_AI_ACCEPT_DEAL_LEADER_CVS_MASINISSA_ANY",
	"The terms are acceptable."	),
	
	-- AI refuses human
	("en_US",	"LOC_DIPLO_MAKE_PEACE_AI_REFUSE_DEAL_LEADER_CVS_MASINISSA_ANY",
	"The world is not big enough to hide from me."	),
	
	-- AI requests from human
	("en_US",	"LOC_DIPLO_MAKE_PEACE_FROM_AI_LEADER_CVS_MASINISSA_ANY",
...
-----------------------------------------------	
	...
	-- AI is Defeated
	("en_US",	"LOC_DIPLO_DEFEAT_FROM_AI_LEADER_CVS_MASINISSA_ANY",
...
--------------------------------------------------------------------
	...
	("en_US",	"LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_MASINISSA_CHAPTER_HISTORY_PARA_2",
	...
	("en_US",	"LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_MASINISSA_CHAPTER_HISTORY_PARA_3",
	...
	("en_US",	"LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_MASINISSA_CHAPTER_HISTORY_PARA_4",
	...
	("en_US",	"LOC_PEDIA_UNITS_PAGE_UNIT_CVS_MASINISSA_UU_CHAPTER_HISTORY_PARA_1",  	
