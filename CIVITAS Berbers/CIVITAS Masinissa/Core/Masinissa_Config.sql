...
VALUES	('Players:Expansion2_Players',	'CIVILIZATION_CVS_BERBER',	'LEADER_CVS_MASINISSA',	'UNIT_CVS_BERBER_UU',			'ICON_UNIT_CVS_BERBER_UU',			'LOC_UNIT_CVS_BERBER_UU_NAME',		'LOC_UNIT_CVS_BERBER_UU_DESCRIPTION',			10			),
		('Players:Expansion2_Players',	'CIVILIZATION_CVS_BERBER',	'LEADER_CVS_MASINISSA',	'IMPROVEMENT_CVS_BERBER_UI',	'ICON_IMPROVEMENT_CVS_BERBER_UI',	'LOC_BUILDING_CVS_BERBER_UI_NAME',	'LOC_IMPROVEMENT_CVS_BERBER_UI_DESCRIPTION',	20			),
