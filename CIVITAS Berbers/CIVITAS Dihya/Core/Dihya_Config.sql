...
VALUES	('Players:StandardPlayers',		'CIVILIZATION_CVS_BERBER',	'LEADER_CVS_DIHYA',	'UNIT_CVS_BERBER_UU',			'ICON_UNIT_CVS_BERBER_UU',			'LOC_UNIT_CVS_BERBER_UU_NAME',		'LOC_UNIT_CVS_BERBER_UU_DESCRIPTION',			10			),
		('Players:StandardPlayers',		'CIVILIZATION_CVS_BERBER',	'LEADER_CVS_DIHYA',	'IMPROVEMENT_CVS_BERBER_UI',	'ICON_IMPROVEMENT_CVS_BERBER_UI',	'LOC_BUILDING_CVS_BERBER_UI_NAME',	'LOC_IMPROVEMENT_CVS_BERBER_UI_DESCRIPTION',	20			),
		...
		('Players:Expansion1_Players',	'CIVILIZATION_CVS_BERBER',	'LEADER_CVS_DIHYA',	'IMPROVEMENT_CVS_BERBER_UI',	'ICON_IMPROVEMENT_CVS_BERBER_UI',	'LOC_BUILDING_CVS_BERBER_UI_NAME',	'LOC_IMPROVEMENT_CVS_BERBER_UI_DESCRIPTION',	20			),
		...
		('Players:Expansion2_Players',	'CIVILIZATION_CVS_BERBER',	'LEADER_CVS_DIHYA',	'IMPROVEMENT_CVS_BERBER_UI',	'ICON_IMPROVEMENT_CVS_BERBER_UI',	'LOC_BUILDING_CVS_BERBER_UI_NAME',	'LOC_IMPROVEMENT_CVS_BERBER_UI_DESCRIPTION',	20			);