...
INSERT INTO RandomEvent_PillagedImprovements
		(RandomEventType,					ImprovementType				)
VALUES	('RANDOM_EVENT_DROUGHT_MAJOR',		'IMPROVEMENT_CVS_BERBER_UI'	),
		('RANDOM_EVENT_DROUGHT_EXTREME',	'IMPROVEMENT_CVS_BERBER_UI'	);